...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">Hello <strong>{{ $fullName }}</strong>,</div>

            <div class="success-message">✓ Your account has been created successfully! Welcome to Philcst Alumni Connect.</div>

            <p class="body-text">Your student profile has been registered in Philcst Alumni Connect. Below you'll find your login credentials to access your account.</p>
            ...
            <div class="profile-box">
                ...
                <p><strong>Course:</strong> {{ $alumni->course_name }} ({{ $alumni->course_code }})</p>
                <p><strong>Graduation Year:</strong> {{ $alumni->batch }}</p>
            </div>
            ...
            <p style="font-size: 13px; color: #555; line-height: 1.6;">If you did not create this account or have any questions, please contact our alumni support team immediately.</p>
        </div>
