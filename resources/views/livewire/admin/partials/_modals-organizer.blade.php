            ...
            <div class="border-2 border-purple-300 rounded-lg p-5 bg-purple-50">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" wire:click="cancelRenamingCollege"
                            class="px-4 py-2.5 border border-slate-300 text-slate-700 rounded-lg text-sm font-semibold hover:bg-slate-50 transition">
                        Cancel
                    </button>
                    <button type="button" wire:click="renameCollege" wire:loading.attr="disabled" wire:target="renameCollege"
                            class="px-5 py-2.5 btn-primary rounded-lg text-sm font-semibold flex items-center gap-2 transition whitespace-nowrap">
                ...
                <div class="space-y-2 max-h-56 overflow-y-auto scrollbar-custom pr-1 mb-4">
                    ...
                    <label class="course-check-row flex items-center gap-3 p-3 border rounded-lg cursor-pointer {{ $isSelected ? 'is-selected border-purple-400' : 'border-slate-200 bg-white' }}">
                        <input type="checkbox" wire:model="orgSelectedCourseCodes" value="{{ $c->code }}"
                               class="w-4 h-4 shrink-0" style="accent-color:#7a3f91;">
...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-sm modal-animate">
        ...
        <div class="p-8">
            ...
            <p class="text-slate-600 text-xs mb-6"><i class="fas fa-circle-info mr-1 text-slate-400"></i>All courses will be unassigned from this college. The courses themselves will <strong>not</strong> be deleted.</p>
            <div class="flex gap-3">
